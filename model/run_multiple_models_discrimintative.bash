...
for modelName in ${RemainingModels[*]}; do
    echo python run_discriminative_task.py -c "${modelName}" -o "../output/discriminative/both-datasets-100-all"
    python run_discriminative_task.py -s 100 -c "${modelName}" -o "../output/discriminative/both-datasets-100-all"
done
