...
for modelName in ${RemainingModels[*]}; do
    echo python run_discriminative_task.py -c "${modelName}" -o "../output/discriminative/both-datasets-10-10"
    python run_discriminative_task.py -c "${modelName}" -o "../output/discriminative/both-datasets-10-10"
done
